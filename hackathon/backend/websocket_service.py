...
class PrizePoolWebSocketService:
    ...
    async def add_client(self, websocket):
        ...
        if self.current_data:
            try:
                ...
                message_data = {"type": "prize_pool_update", "data": clean_data}
    ...
    async def broadcast_to_clients(self, data: dict):
        ...
        message = json.dumps({"type": "prize_pool_update", "data": clean_data})
            ...
            try:
                ...
                async with websockets.connect(self.helius_ws_url) as websocket:
                    ...
                    subscription_request = {
                        ...
                        "params": [
                            {"failed": False, "accountInclude": [self.prize_wallet]},
                            {
    ...
    def fetch_prize_pool_sync(self) -> dict:
        ...
        try:
            ...
            native_balance = (
                float(result.get("nativeBalance", {}).get("lamports", 0)) / 1_000_000_000

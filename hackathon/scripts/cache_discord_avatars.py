...
def main():
    ...
    try:
        ...
        logger.info(f"✅ Complete! Cached {cached_count} custom avatars, generated {generated_count} fallback avatars, updated {db_updated_count} database records, {error_count} errors")
